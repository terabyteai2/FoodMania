...
class PosColors {
  ...
  static const Color blue600 = Color(0xFF2440B8); // press
  ...
  // ── Ink — neutral slate ─────────────────────────────────────────────────
  static const Color primaryDark = Color(0xFF23262B); // ink
  static const Color ink = Color(0xFF23262B); // explicit --ink alias
  ...
  static const Color background = Color(0xFFF3F4F6); // bg
  ...
  // Dark chrome (billing rail + payment strip — pos_web tokens.css)
  static const Color railBg = Color(0xFF3A4048);
  static const Color railItem = Color(0xFF454C55);
  static const Color railLine = Color(0xFF2F343B);
  static const Color stripBg = Color(0xFF2E3237);
  static const Color stripInk = Color(0xFFFFFFFF);
  static const Color trackInk = Color(0x241B2330);

  // ── Dark navigation sidebar (web target aesthetic) ──────────────────────
  // The collapsible rail uses a dark slate background with blue active accent,
  // matching the target web app's dark left nav. Text is soft white; the active
  // row gets a blue left bar + primarySoft tint.
  static const Color navBg = Color(0xFF2D3142);
  static const Color navItemActive = Color(0xFF3A4054);
  static const Color navLine = Color(0xFF3D4254);
  static const Color navText = Color(0xFFE6E9F0);
  static const Color navTextMuted = Color(0xFF9CA3B5);
  static const Color navAccent = primary; // blue left bar on active row
  ...
  // ── Borders ─────────────────────────────────────────────────────────────
  static const Color line = Color(0xFFE3E6EA); // line
  static const Color lineStrong = Color(0xFFC9CFD8); // line-2
  ...
  static const Color warningSoft = Color(0xFFFCF3CF);
...
class PosShadows {
  ...
  static const List<BoxShadow> soft = [
    BoxShadow(color: Color(0x14141928), blurRadius: 3, offset: Offset(0, 1)),
  ];
  static const List<BoxShadow> pop = [
    BoxShadow(color: Color(0x2E141928), blurRadius: 28, offset: Offset(0, 8)),
  ];
