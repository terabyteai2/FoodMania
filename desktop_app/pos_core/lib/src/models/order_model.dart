...
class OrderModel {
  ...
  factory OrderModel.fromMap(
    ...
    return OrderModel(
      ...
      // Backend returns the order number as `serialNumber`; accept either key
      // so synced orders keep their sequence (otherwise displaySequence falls
      // back to "#-").
      sequenceNo: _readInt(map['sequenceNo'] ?? map['serialNumber']),
