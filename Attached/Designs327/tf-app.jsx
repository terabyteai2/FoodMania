...
function DesignCanvasTree() {
  const t = useTfTweaks();
  const PCW = PC.W, PCH = PC.H;
  return (
    <DesignCanvas>
      <DCSection id="computer-os" title="Computer OS · Windows laptop POS"
        subtitle="Phase 1 FOH foundation + Phase 2 essential analytics. Offline-first, EN/BN, USB + Bluetooth thermals. Same plum + paper tokens as mobile, desktop layout adapter: 72px rail · 1366×820 (Windows 10/11 min) · top toolbar · F-key driven · right-click + tooltips · status bar.">
        <DCArtboard id="pc-counter" label="1 · Counter mode · quick sell (the daily driver)" width={PCW} height={PCH}><PC_Counter /></DCArtboard>
        <DCArtboard id="pc-floor" label="2 · Dine-in floor · 3 zones · 22 tables" width={PCW} height={PCH}><PC_Floor /></DCArtboard>
        <DCArtboard id="pc-order" label="3 · Order detail · Table T7 (KOT + bill)" width={PCW} height={PCH}><PC_Order /></DCArtboard>
        <DCArtboard id="pc-split" label="3b · Bill split modal · 2 payers" width={PCW} height={PCH}><PC_Order withSplitModal /></DCArtboard>
        <DCArtboard id="pc-open" label="4 · Open day · cash drawer count" width={PCW} height={PCH}><PC_DayOpen /></DCArtboard>
        <DCArtboard id="pc-z" label="5 · Close day · Z report" width={PCW} height={PCH}><PC_Zreport /></DCArtboard>
        <DCArtboard id="pc-rep-today" label="6 · Analytics · today (hourly vs avg)" width={PCW} height={PCH}><PC_AnalyticsToday /></DCArtboard>
        <DCArtboard id="pc-rep-items" label="7 · Analytics · items (top / slow / margin)" width={PCW} height={PCH}><PC_AnalyticsItems /></DCArtboard>
        <DCArtboard id="pc-rep-staff" label="8 · Analytics · staff & footfall" width={PCW} height={PCH}><PC_AnalyticsStaff /></DCArtboard>
      </DCSection>
      ...
      <DCSection id="dashboard-review" title="Dashboard · Owner view"
        subtitle="Period-driven analytics: revenue + plain-language delta, monochrome line chart with prior period as a dashed reference, Excel-like menu table. Three positions of the complexity dial — STANDARD covers food cart + cafe; ADVANCED adds margin + staff for the restaurant; ENTERPRISE pivots to fleet comparison.">
        <DCArtboard id="rev-std" label="STANDARD · food cart + cafe (Cha Ghor shown)" width={PW} height={PH}><Phone><Review_Standard /></Phone></DCArtboard>
        <DCArtboard id="rev-adv" label="ADVANCED · restaurant (Spice Garden)" width={PW} height={PH}><Phone><Review_Advanced /></Phone></DCArtboard>
        <DCArtboard id="rev-ent" label="ENTERPRISE · chain (5 outlets)" width={PW} height={PH}><Phone><Review_Enterprise /></Phone></DCArtboard>
      </DCSection>
