...
const FOHTile = ({ n, p, cat, glyph, tint, qty, onClick /* emoji ignored */ }) => {
  const active = !!qty;
  return (
    <div onClick={onClick} style={{
      ...
      borderRadius: 12, padding: '12px 12px 12px 14px', minHeight: 96,
...
const FOHCounter = ({ title = 'Counter · top sellers', tiles, cols = 3, action }) =>
<div>
...
Object.assign(window, {
  ...
  CategoryGlyph, LineChart, LineChartCard, MenuPerfTable
});