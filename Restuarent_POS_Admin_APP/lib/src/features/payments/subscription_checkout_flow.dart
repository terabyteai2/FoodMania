...
class SubscriptionCheckoutFlow {
  ...
  static Future<bool> _runDemoDialog(
    ...
    await AppScope.of(context).markTemporaryBkashPaymentVerified(
      plan: plan,
      amount: amount,
    );
    return true;
...
class _UddoktaCheckoutPageState extends State<_UddoktaCheckoutPage> {
  ...
  Future<void> _startCheckout() async {
    ...
    try {
      ...
      controller.setNavigationDelegate(
        NavigationDelegate(
          ...
          onWebResourceError: (err) {
            ...
            final isGatewayError = desc.contains('502') ||
                desc.contains('503') ||
      ...
      setState(() {
        _loading = false;
        _error = message;
        _gatewayPageError = message.contains('public HTTPS') ||
  ...
  String get _gatewayUnavailableMessage =>
      _sandboxMode
  ...
  bool _isSuccessUrl(String url) {
    ...
    if (uri.path.contains('/payments/uddokta/return')) return true;
    return uri.queryParameters['status']?.toLowerCase() == 'success';
  }
