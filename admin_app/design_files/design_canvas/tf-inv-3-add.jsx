...
const Inv3_Add = () => (
  ...
  >
    ...
    {/* SECTION 1 — Identity */}
    <FormSection n={1} label="Identity" top={4}>
    ...
    <FormSection n={2} label="Measurement">
      <div style={{
    ...
    <FormSection n={4} label="Stock constraints">
      <FieldRow>
    ...
    <FormSection n={5} label="Supplier">
      <div style={{
