  ...
  >
    ...
    <InvAppBar
      ...
      trailing={(
        <>
          ...
          <InvIconBtn pip><InvIcon kind="bell" s={18} /></InvIconBtn>
        </>
      )}
    />
    ...
    <Section top={22}>
      ...
      <DashCard padded={false} style={{ overflow: 'hidden' }}>
        ...
        {[
          { l: 'R', n: 'Rice',     bn: 'চাল',     onHand: '12',  unit: 'kg', today: '—',     todayTone: 'mute',   status: 'good' },
          { l: 'M', n: 'Mutton',   bn: 'খাসি',   onHand: '0.8', unit: 'kg', today: '−1.8',  todayTone: 'danger', status: 'warn' },
          { l: 'C', n: 'Chicken',  bn: 'মুরগি', onHand: '4.2', unit: 'kg', today: '−2.5',  todayTone: 'down',   status: 'good' },
          { l: 'O', n: 'Onion',    bn: 'পেঁয়াজ', onHand: '6.0', unit: 'kg', today: '−0.7',  todayTone: 'down',   status: 'good' },
          { l: 'S', n: 'Soy oil',  bn: 'তেল',     onHand: '8.5', unit: 'ltr',today: '−0.4', todayTone: 'down',   status: 'good' },
          { l: 'P', n: 'Potato',   bn: 'আলু',     onHand: '4.5', unit: 'kg', today: '—',     todayTone: 'mute',   status: 'good' },
        ].map((it, i, arr) => {
