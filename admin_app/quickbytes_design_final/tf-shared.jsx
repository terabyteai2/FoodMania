...
const NAV_DEFAULT = [
  { kind: 'orders', label: 'Orders', bn: 'অর্ডার' },
  { kind: 'menu', label: 'Menu', bn: 'মেনু' },
  { kind: 'home', label: 'Home', bn: 'হোম' },
  { kind: 'inventory', label: 'Stock', bn: 'স্টক' },
  { kind: 'settings', label: 'More', bn: 'আরও' },
];
