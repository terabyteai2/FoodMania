...
const SIMPLE_ITEMS = [
  { n: 'Lemon Mint',   bn: 'লেবু মিন্ট', p: 60,  tone: '#EAF4EE' },
  { n: 'Lebu Soda',    bn: 'লেবু সোডা',  p: 50,  tone: '#FFF3E0' },
  { n: 'Ginger Lemon', bn: 'আদা লেবু',   p: 70,  tone: '#FBE4DB' },
  { n: 'Plain Lebu',   bn: 'লেবু',       p: 40,  tone: '#EAF4EE' },
  { n: 'Cha',          bn: 'চা',         p: 20,  tone: '#FFF9E0' },
  { n: 'Singara',      bn: 'সিঙ্গাড়া',   p: 15,  tone: '#FEF1C5' },
];
...
const FOH_Simple = () => (
  <div style={{
    ...
    <div style={{ position: 'absolute', inset: 0, overflowY: 'auto', paddingBottom: 70 + 70 }}>
      <FOHHeader
        title="New sale"
        sub="Counter · Lebu Fresh"
        trailing={(
          <div style={{
            padding: '6px 10px', height: 32, borderRadius: 8,
            background: DASH.accentSoft, color: DASH.accentInk,
            border: `1px solid ${DASH.accent}55`,
            fontSize: 10.5, fontFamily: DASH.mono, fontWeight: 700, letterSpacing: 0.5,
            display: 'inline-flex', alignItems: 'center', gap: 6,
          }}>
            <span style={{ width: 6, height: 6, borderRadius: 3, background: DASH.accent }} />
            COUNTER MODE
          </div>
        )}
      />
          ...
          {SIMPLE_ITEMS.map((it, i) => (
            <div key={i} style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 10.5, color: DASH.textTer, marginTop: 2, fontFamily: DASH.bn }}>{it.bn}</div>
              </div>
...
const STD_MENU = [
  { n: 'Milk Tea (Cha)', bn: 'দুধ চা',    p: 30,  cat: 'Cha' },
  { n: 'Lemon Tea',      bn: 'লেবু চা',   p: 20,  cat: 'Cha' },
  { n: 'Singara',        bn: 'সিঙ্গাড়া', p: 15,  cat: 'Snacks', qty: 4 },
  { n: 'Samosa',         bn: 'সমুচা',     p: 30,  cat: 'Snacks', qty: 2 },
  { n: 'Egg Toast',      bn: 'ডিম টোস্ট', p: 25,  cat: 'Snacks' },
];
            ...
            <div key={i} style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 11, color: DASH.textTer, marginTop: 2, display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ fontFamily: DASH.bn }}>{it.bn}</span>
...
const ADV_LINES = [
  {
    n: 'Beef Tehari', bn: 'বিফ তেহারি', qty: 2, price: 900,
    mods: ['no onion', 'extra raita'],
    tags: [{ l: 'Halal', t: 'halal' }],
    sent: '7:48 PM',
  },
  {
    n: 'Mutton Roast', bn: 'খাসির রোস্ট', qty: 1, price: 400,
    mods: ['medium spicy'],
    tags: [{ l: 'Halal', t: 'halal' }, { l: 'Nut', t: 'nut' }],
    sent: '7:48 PM',
  },
  {
    n: 'Borhani', bn: 'বোরহানি', qty: 4, price: 200,
    mods: [],
    tags: [{ l: 'Veg', t: 'veg' }],
    sent: null,
  },
...
const FOH_Advanced = () => (
  <div style={{
    ...
    <div style={{ position: 'absolute', inset: 0, overflowY: 'auto', paddingBottom: 70 + 96 }}>
      <FOHHeader
        title="Table 12 · 4 covers"
        sub="Spice Garden · seated 7:42 PM"
        trailing={(
          <div style={{
            padding: '6px 10px', height: 32, borderRadius: 8,
            background: DASH.surface, border: `1px solid ${DASH.border}`,
            ...
            <div key={i} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: DASH.textTer, marginTop: 2, fontFamily: DASH.bn }}>{it.bn}</div>
                  {it.mods.length > 0 && (
