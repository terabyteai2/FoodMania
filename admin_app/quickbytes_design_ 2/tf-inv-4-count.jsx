  ...
  >
    ...
    <Section top={10}>
      ...
      <DashCard padded={false} style={{ overflow: 'hidden' }}>
        <CountRow
          first letter="R" name="Rice" was="13.2" unit="kg"
          entered="12.0" msg="−1.2 kg · matches average use"
          msgTone="good"
        />
        <CountRow
          letter="C" name="Chicken" was="6.7" unit="kg"
          entered="4.2" msg="−2.5 kg · within forecast"
          msgTone="good"
        />
        <CountRow
          letter="M" name="Mutton" was="2.6" unit="kg"
          entered="0.8" status="focus"
          msg="−1.8 kg variance · ৳1,980 — verify"
          msgTone="urgent"
        />
        <CountRow
          letter="O" name="Onion" was="6.7" unit="kg"
          entered="6.0" msg="−0.7 kg · expected"
          msgTone="good"
        />
        <CountRow
          letter="S" name="Soy oil" was="8.9" unit="ltr"
          entered="8.5" msg="−0.4 ltr · expected"
          msgTone="good"
        />
        <CountRow
          letter="P" name="Potato" was="4.5" unit="kg"
          entered={null} msg="Awaiting count"
          msgTone="pending"
        />
        <CountRow
          letter="E" name="Eggs" was="48" unit="pcs"
          entered={null} msg="Awaiting count"
          msgTone="pending"
        />
        <CountRow
          letter="G" name="Ginger" was="1.4" unit="kg"
          entered={null} msg="Awaiting count"
          msgTone="pending"
        />
      </DashCard>
    ...
    {/* AI Scan floating button — bottom-right, accent. Same pattern as the
        new Stock-in page: tap to auto-fill counts from a shelf photo. */}
    <div style={{
