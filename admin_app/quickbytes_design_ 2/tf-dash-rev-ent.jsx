...
const Review_Enterprise = () => (
  <DashScreen navActive={2}>
    <TopNav title="Dashboard" role="owner" badge={6} />
    ...
    <Section top={14}>
      <SecHead title="Revenue by hour · fleet" action="7-day" />
      <HourlyCard
    ...
    <Section top={14}>
      <SecHead title="Capacity right now" action="Tonight" />
      <DashCard padded={false} style={{ overflow: 'hidden' }}>
    ...
    <Section top={14}>
      ...
      <DashCard padded={false} style={{ overflow: 'hidden' }}>
        <TopItemRow first rank={1} name="Beef Tehari"  qty={184} rev="৳1,84,000" margin="৳1,18,260" foodCost={28} />
        <TopItemRow       rank={2} name="Chicken Tikka" qty={156} rev="৳53,040"   margin="৳32,890"   foodCost={31} />
        <TopItemRow       rank={3} name="Mutton Roast"  qty={92}  rev="৳36,800"   margin="৳18,420"   foodCost={42} warnLabel="low margin" />
        <TopItemRow       rank={4} name="Milk Tea"       qty={428} rev="৳12,840"   margin="৳9,420"    foodCost={20} />
        <TopItemRow       rank={5} name="Borhani"      qty={284} rev="৳14,200"   margin="৳7,960"    foodCost={28} />
      </DashCard>
    </Section>
