class PaymentDefaults {
  ...
  /// First-time manager onboarding (after restaurant name).
  static const double onboardingPlanAmount = monthlyPlanAmount;
  static const String onboardingPlanName = 'monthly';
  ...
  /// Online checkout (UddoktaPay) disabled until a new gateway is wired in.
