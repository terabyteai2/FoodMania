...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!app.initialized && app.lastError == null) {
      return LoadingView(message: app.strings.preparingCloudWorkspace);
    }
    ...
    final topItem = topItems.isEmpty ? app.strings.noItem : topItems.first.name;
            ...
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    CompactHeader(
                      title: _greeting(text),
                      subtitle:
                          '${app.restaurantName.isEmpty ? text.restaurantDashboard : app.restaurantName} · ${app.accountRole.label} · ${DateFormat('EEE, MMM d').format(DateTime.now())}',
                      actions: [
                        CompactIconButton(
                    ...
                    SizedBox(height: 16),
                    CompactSectionLabel(label: text.todayLabel),
                    SizedBox(height: 8),
                    _MetricGrid(
                    ...
                    _ShiftCommandCenter(
                      ...
                      peakHourLabel: _peakHour(hourlyStats, text),
                    ...
                    SizedBox(height: 16),
                    CompactSectionLabel(label: text.quickActions),
                    SizedBox(height: 8),
                    _QuickActions(
  ...
  String _greeting(AppStrings text) {
  ...
  String _peakHour(List<int> hourlyStats, AppStrings text) {
    if (hourlyStats.isEmpty || hourlyStats.every((value) => value == 0)) {
      return text.noRushYet;
    }
    var maxIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return CompactSurface(
      ...
      child: Column(
        ...
        children: [
          Text(
            AppScope.of(context).strings.todaysSales,
            style: TextStyle(
          ...
          SizedBox(height: 2),
          Text(
            AppScope.of(context).strings.todaysSalesBn,
            style: TextStyle(
              color: PosColors.muted,
              fontSize: 9,
          ...
          Row(
            children: [
              ...
              SizedBox(width: 7),
              Text(
                AppScope.of(context).strings.vsYesterday,
                style: TextStyle(
                  color: PosColors.muted,
                  fontSize: 10,
                  fontWeight: FontWeight.w700,
...
class _QuickActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final actions = [
      _QuickAction(Icons.add_rounded, t.order, onNewOrder),
      _QuickAction(Icons.sync_rounded, t.sync, () async => onSync()),
      _QuickAction(Icons.restaurant_menu_rounded, t.menu, onOpenMenu),
      _QuickAction(Icons.inventory_2_outlined, t.inventory, onOpenStock),
      _QuickAction(Icons.assessment_outlined, t.report, onOpenReports),
    ];
    return Row(
      children: [
          ...
          Row(
            children: [
              ...
              _TinyPill(
                ...
                label: text.tablesLabel(activeTables, totalTables.clamp(1, 999)),
...
class _SourceMixCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _DashboardPanel(
      title: text.orderChannels,
      icon: Icons.hub_outlined,
      child: sources.isEmpty
          ? _EmptyMiniText(text.noOrdersByChannel)
          : Column(
              children: [
...
class _TopItemsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _DashboardPanel(
      ...
      child: items.isEmpty
          ? _EmptyMiniText(text.noSalesMixToday)
          : Column(
              children: [
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  AppScope.of(context).strings.inventoryWatchlist,
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900),
                ),
              ),
          ...
          SizedBox(height: 8),
          if (items.isEmpty)
            _EmptyMiniText(AppScope.of(context).strings.stockHealthy)
          else
            ...items.map((item) {
...
class _CategoryBreakdownCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final text = AppScope.of(context).strings;
    return _DashboardPanel(
      title: text.categorySalesTitle,
      icon: Icons.category_outlined,
      child: stats.isEmpty
          ? _EmptyMiniText(AppScope.of(context).strings.noCategoryDataToday)
          : Column(
              children: [
...
class _OperationsPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final t = AppScope.of(context).strings;
    final rows = [
      _OpsRow(Icons.pending_actions_rounded, t.pendingOrders, '$pending'),
      _OpsRow(Icons.room_service_rounded, t.inPreparation, '$accepted'),
      _OpsRow(Icons.hourglass_bottom_rounded, t.staleOver15, '$staleOrders'),
      _OpsRow(Icons.inventory_2_outlined, t.lowStockAlerts, '$lowStock'),
      _OpsRow(Icons.no_meals_outlined, t.unavailableMenuItems, '$unavailable'),
      _OpsRow(Icons.cloud_sync_rounded, t.waitingToSync, '$syncPending'),
      _OpsRow(
        printerReady ? Icons.print_rounded : Icons.print_disabled_outlined,
        t.printer,
        printerReady ? t.printerReady : t.printerNotReady,
      ),
    ];
    return CompactSurface(
      padding: EdgeInsets.all(14),
        ...
        children: [
          ...
          if (orders.isEmpty)
            Padding(
              ...
              child: Center(child: Text(text.noOrdersYetToday)),
            )
          else
            ...orders.map((order) {
              return ListTile(
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  AppScope.of(context).strings.staffLeaderboard,
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900),
                ),
              ),
              Text(
                AppScope.of(context).strings.salesToday,
                style: TextStyle(
                  color: PosColors.muted,
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
          ...
          if (rows.isEmpty)
            Padding(
              ...
              child: Text(
                AppScope.of(context).strings.noTrackedOrdersYetToday,
                style: TextStyle(
                  color: PosColors.muted,
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
