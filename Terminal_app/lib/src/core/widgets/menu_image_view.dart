...
/// Maps an icon key to a local asset path if available.
String? menuIconKeyToAsset(String? key) {
  ...
  switch (normalized) {
    case 'pizza':
      return 'assets/menu_placeholders/appetizer.png';
    case 'burger':
      return 'assets/menu_placeholders/burger.png';
    case 'sandwich':
      return 'assets/menu_placeholders/sandwitch.png';
    case 'biryani':
      return 'assets/menu_placeholders/biryani-1.png';
    case 'rice':
      return 'assets/menu_placeholders/biryani-2.png';
    case 'curry':
      return 'assets/menu_placeholders/grill.png';
    case 'soup':
      return 'assets/menu_placeholders/soup.png';
    case 'dal':
      return 'assets/menu_placeholders/dal-1.png';
    case 'salad':
    case 'vegetable':
      return 'assets/menu_placeholders/vegetable-1.png';
    case 'noodle':
    case 'noodles':
      return 'assets/menu_placeholders/noodles.png';
    case 'pasta':
      return 'assets/menu_placeholders/pasta.png';
    case 'bread':
      return 'assets/menu_placeholders/appetizer.png';
    case 'chicken':
      return 'assets/menu_placeholders/chicken-1.png';
    case 'fish':
      return 'assets/menu_placeholders/fish-1.png';
    case 'beef':
      return 'assets/menu_placeholders/beef-1.png';
    case 'mutton':
      return 'assets/menu_placeholders/mutton-1.png';
    case 'kebab':
      return 'assets/menu_placeholders/kebab.png';
    case 'grill':
      return 'assets/menu_placeholders/grill.png';
    case 'appetizer':
    case 'snack':
      return 'assets/menu_placeholders/appetizer.png';
    case 'fuchka':
      return 'assets/menu_placeholders/fuchka.png';
    case 'fruit':
    case 'juice':
      return 'assets/menu_placeholders/juice.png';
    case 'dessert':
    case 'sweets':
      return 'assets/menu_placeholders/sweets.png';
    case 'drink':
    case 'beverages':
      return 'assets/menu_placeholders/beverages.png';
    case 'soft_drink':
      return 'assets/menu_placeholders/soft-drink.png';
    case 'coffee':
    case 'tea':
      return 'assets/menu_placeholders/tea_and_coffee.png';
    case 'breakfast':
      return 'assets/menu_placeholders/appetizer.png';
    case 'water':
      return 'assets/menu_placeholders/water.png';
    default:
      return null;
  }
}
