...
class PosColors {
  ...
  static const Color primary = Color(
    0xFF4C1D5E,
  ); // accent — CTAs, FAB, focused states
  static const Color primaryDeep = Color(
    0xFF351244,
  ); // accentDeep — pressed states
  static const Color primaryMid = Color(
    0xFF6B3080,
  ); // accentMid — secondary CTAs
  static const Color primarySoft = Color(
    0xFFE8D8F0,
  ); // accentSoft — selected backgrounds
  static const Color primaryWash = Color(
    0xFFF4EDF8,
  ); // accentWash — hover tints only
  static const Color accentInk = Color(
    0xFFFFFFFF,
  ); // text/icons on accent surfaces
  ...
  static const Color inkSoft = Color(
    0xFF2D2438,
  ); // inkSoft — secondary emphasis

  // Scaffold — Neutral-cool violet base
  static const Color background = Color(
    0xFFF8F8FA,
  ); // paper — scaffold background
  static const Color surface = Color(
    0xFFFFFFFF,
  ); // surface — cards, sheets, inputs
  static const Color surfaceSunk = Color(
    0xFFF1F1F5,
  ); // surfaceSunk — search wells, fills
  ...
  static const Color urgent = Color(
    0xFF9A3412,
  ); // late orders, expedite signals
