...
class PrinterService {
  ...
  KotTicketData _buildKotTicketData(
    ...
    return KotTicketData(
      ...
      timeLabel: 'Time',
      timeValue: _formatKotTime(order.createdAt),
      typeLabel: 'Type',
      typeValue: _kotTypeLabel(serviceType),
      tableLabel:
  ...
  String _kotTypeLabel(OrderServiceType serviceType) {
    switch (serviceType) {
