...
SYNC_KEYS=(
  ...
  SARVAM_API_KEY
<<<<<<< Updated upstream
  SARVAM_STT_USE_REALTIME
  SARVAM_STT_STREAM_TYPE
  SARVAM_STT_ENDPOINTING
  SARVAM_STT_SILENCE_MS
  SARVAM_STT_THRESHOLD
=======
>>>>>>> Stashed changes
  SARVAM_STT_MODEL
  SARVAM_STT_LANGUAGE
  SARVAM_LLM_MODEL
  SARVAM_LLM_TEMPERATURE
...
<<<<<<< Updated upstream
  ...
  SARVAM_TTS_MIN_BUFFER
  SARVAM_TTS_MAX_CHUNK
=======
  SARVAM_TTS_MODEL
  SARVAM_TTS_SPEAKER
  SARVAM_TTS_LANGUAGE
